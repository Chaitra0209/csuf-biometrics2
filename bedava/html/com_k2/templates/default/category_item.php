...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="catItemHeader">
	  ...
	  <?php endif; ?>
		...
		<!-- Item Author -->
		<span class="catItemAuthor"><i class="icon-user"></i> 
  ...
  <div class="catItemLinks">
		...
		<div class="catItemCategory">
			<span><i class="icon-bookmark-empty"></i> <?php echo JText::_('K2_PUBLISHED_IN'); ?></span>
	  ...
	  <div class="catItemTagsBlock">
		  ...
		  <ul class="catItemTags">
		    ...
		    <li><a class="label label-important" href="<?php echo $tag->link; ?>"><?php echo $tag->name; ?></a></li>
		    <?php endforeach; ?>
		  </ul>
		  <div class="clr"></div>
	  </div>
  ...
  <div class="pull-right">
	...
	<div class="catItemCommentsLink">
		...
		<?php else: ?>
			...
			<a class="btn btn-inverse" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
				<i class="icon-comment-alt"></i> <?php echo $this->item->numOfComments; ?> <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?>
			</a>
			<?php else: ?>
			<a class="btn btn-inverse" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
				<i class="icon-comment-alt"></i> <?php echo JText::_('K2_BE_THE_FIRST_TO_COMMENT'); ?>
			</a>
			<?php endif; ?>
		<?php endif; ?>
	</div>
	...
	<div class="catItemReadMore">
		<a class="k2ReadMore btn btn-primary" href="<?php echo $this->item->link; ?>">
			<i class="icon-chevron-right"></i> <?php echo JText::_('K2_READ_MORE'); ?>
		</a>
	</div>
	<?php endif; ?>
  </div>
