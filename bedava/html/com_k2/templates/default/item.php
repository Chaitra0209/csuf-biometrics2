...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
	  ...
	  <?php echo $this->item->event->K2BeforeDisplayContent; ?>
		...
		<div class="itemImageBlock">
		  ...
		  <!-- Image caption -->
		  <span class="itemImageCaption"><blockquote class="pull-right"><small><?php echo $this->item->image_caption; ?></small></blockquote></span>
		  <?php endif; ?>
  ...
  <div class="itemLinks">
	  ...
	  <div class="itemTagsBlock">
		  <i class="icon-tags"></i> <span><?php echo JText::_('K2_TAGGED_UNDER'); ?></span>
		  <ul class="itemTags">
		    <?php foreach ($this->item->tags as $tag): ?>
		    <li><a class="btn btn-danger" href="<?php echo $tag->link; ?>"><?php echo $tag->name; ?></a></li>
		    <?php endforeach; ?>
		  </ul>
		  <div class="clr"></div>
	  </div>
	  ...
	  <div class="itemAttachmentsBlock">
		  <span><i class="icon-cloud-download"></i> <?php echo JText::_('K2_DOWNLOAD_ATTACHMENTS'); ?></span>
